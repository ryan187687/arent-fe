import { HealthyItem } from '@/components/molecules/HealthyItem';
import { HealthyDTO, HealthyEntity } from '@/models';
import { getHealthyRequest } from '@/requests/healthy.request';
import { requestServer } from '@/services/requestServer';
import { isEmptyLodash } from '@/utils';
import { mapHealthyDtoToEntity } from '@/utils/mapper/healthy.mapper';
